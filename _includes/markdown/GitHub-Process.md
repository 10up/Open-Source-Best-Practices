...
Our Distributor project recently [added a GitHub Action to automatically build hook documentation](https://github.com/10up/distributor/pull/448).  Where feasible, we should look to replicate that [new GitHub Action](https://github.com/10up/distributor/blob/develop/includes/.github/workflows/build-docs.yml) across other projects to improve our level of technical documentation.
