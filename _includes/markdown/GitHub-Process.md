...
- `type:dependency` - “An issue with a separate library that this project relies upon (aka a dependency).” (color: #D6783A)
...
- `resolution:duplicate` - “This issue has already been logged.” (color: #000000)
